...
| "l" + txHash           | {hash,num,TxIndex} | Transaction hashes can find blocks and transactions                                                                             | When a block joins a canonical blockchain                                               | When the block is removed from the canonical blockchain                                                                                                                                                                                                                     |
